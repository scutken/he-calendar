...
// node_modules/tyme4ts/dist/lib/index.cjs
var require_lib = __commonJS({
  "node_modules/tyme4ts/dist/lib/index.cjs"(exports2) {
    "use strict";
    ...
    var Phase = class _Phase extends LoopTyme {
      ...
      getStartSolarTime() {
        ...
        const d = LunarDay2.fromYmd(this.lunarYear, this.lunarMonth, 1).getSolarDay();
        while (true) {
    ...
    var PengZu2 = class _PengZu extends AbstractCulture {
      pengZuHeavenStem;
      pengZuEarthBranch;
    ...
    var SixtyCycle = class _SixtyCycle extends LoopTyme {
      ...
      getPengZu() {
        return PengZu2.fromSixtyCycle(this);
      }
      getTen() {
    ...
    var FetusDay2 = class _FetusDay extends AbstractCulture {
      fetusHeavenStem;
      fetusEarthBranch;
      side;
      direction;
    ...
    var LunarMonth = class _LunarMonth extends MonthUnit {
      ...
      getNewMoon() {
        const y = this.getYear();
        const dongZhiJd = SolarTerm2.fromIndex(y, 0).getCursoryJulianDay();
      ...
      getName() {
        return (this.isLeap() ? "\u95F0" : "") + _LunarMonth.NAMES[this.getMonth() - 1];
      }
      toString() {
      ...
      getDays() {
        ...
        for (let i = 1, j = this.getDayCount(); i <= j; i++) {
          l.push(LunarDay2.fromYmd(y, m, i));
        }
        return l;
      }
      getFirstDay() {
        return LunarDay2.fromYmd(this.getYear(), this.getMonthWithLeap(), 1);
      }
      getWeeks(start) {
        const y = this.getYear();
        const m = this.getMonthWithLeap();
    ...
    var LunarWeek = class _LunarWeek extends WeekUnit {
      ...
      next(n) {
        ...
        if (n === 0) {
          return _LunarWeek.fromYm(this.getYear(), this.getMonth(), this.getIndex(), startIndex);
        }
      ...
      getFirstDay() {
        const firstDay = LunarDay2.fromYmd(this.getYear(), this.getMonth(), 1);
    ...
    var LunarDay2 = class _LunarDay extends DayUnit {
      ...
      getSixtyCycle() {
        const offset = ~~this.getLunarMonth().getFirstJulianDay().next(this.getDay() - 12).getDay();
      ...
      getNineStar() {
        ...
        const dongZhi = SolarTerm2.fromIndex(d.getYear(), 0);
      ...
      getFetusDay() {
        return FetusDay2.fromLunarDay(this);
      }
      getPhaseDay() {
      ...
      getFestival() {
        return LunarFestival2.fromYmd(this.getYear(), this.getMonth(), this.getDay());
      }
      getSixStar() {
    ...
    var SixtyCycleMonth = class _SixtyCycleMonth extends AbstractTyme {
      ...
      getFirstDay() {
        return SixtyCycleDay.fromSolarDay(SolarTerm2.fromIndex(this.year.getYear(), 3 + this.getIndexInYear() * 2).getSolarDay());
      }
      getDays() {
        const l = [];
    ...
    var SixtyCycleDay = class _SixtyCycleDay extends AbstractTyme {
      ...
      static fromSolarDay(solarDay) {
        ...
        return new _SixtyCycleDay(solarDay, month, SixtyCycle.fromIndex(solarDay.subtract(SolarDay2.fromYmd(2e3, 1, 7))));
      }
      getSolarDay() {
      ...
      getNineStar() {
        ...
        const dongZhi = SolarTerm2.fromIndex(solar.getYear(), 0);
        const dongZhiSolar = dongZhi.getSolarDay();
        const xiaZhiSolar = dongZhi.next(12).getSolarDay();
        const dongZhiSolar2 = dongZhi.next(24).getSolarDay();
        const dongZhiIndex = dongZhiSolar.getLunarDay().getSixtyCycle().getIndex();
      ...
      getFetusDay() {
        return FetusDay2.fromSixtyCycleDay(this);
      }
      getTwentyEightStar() {
    ...
    var SixtyCycleHour = class _SixtyCycleHour extends AbstractTyme {
      ...
      constructor(solarTime) {
        ...
        const springSolarTime = SolarTerm2.fromIndex(solarYear, 3).getJulianDay().getSolarTime();
        ...
        if (index < 0 && term.getJulianDay().getSolarTime().isAfter(SolarTerm2.fromIndex(solarYear, 3).getJulianDay().getSolarTime())) {
          index += 24;
        }
    ...
    var ThreePillars = class extends AbstractCulture {
      ...
      getSolarDays(startYear, endYear) {
        ...
        while (y <= endYear) {
          let term = SolarTerm2.fromIndex(y, 3);
          if (m > 0) {
            term = term.next(m);
          }
    ...
    var LunarHour = class _LunarHour extends SecondUnit {
      ...
      getSixtyCycle() {
        const earthBranchIndex = this.getIndexInDay() % 12;
        let d = this.getLunarDay().getSixtyCycle();
        if (this.getHour() >= 23) {
          d = d.next(1);
        }
    ...
    var SolarTerm2 = class _SolarTerm extends LoopTyme {
    ...
    var SolarMonth = class _SolarMonth extends MonthUnit {
      ...
      getWeekCount(start) {
        return Math.ceil((this.indexOf(SolarDay2.fromYmd(this.getYear(), this.getMonth(), 1).getWeek().getIndex() - start, 7) + this.getDayCount()) / 7);
      }
      getName() {
      ...
      getDays() {
        ...
        const m = this.getMonth();
        for (let i = 1, j = this.getDayCount(); i <= j; i++) {
          l.push(SolarDay2.fromYmd(y, m, i));
        }
        return l;
      }
      getFirstDay() {
        return SolarDay2.fromYmd(this.getYear(), this.getMonth(), 1);
      }
    };
    var SolarWeek = class _SolarWeek extends WeekUnit {
      ...
      getFirstDay() {
        const firstDay = SolarDay2.fromYmd(this.getYear(), this.getMonth(), 1);
        return firstDay.next(this.getIndex() * 7 - this.indexOf(firstDay.getWeek().getIndex() - this.getStart(), 7));
      }
      getDays() {
        const l = [];
    ...
    var SolarDay2 = class _SolarDay extends DayUnit {
      ...
      getTermDay() {
        ...
        let term = SolarTerm2.fromIndex(y, i + 1);
      ...
      getDogDay() {
        const xiaZhi = SolarTerm2.fromIndex(this.getYear(), 12);
      ...
      getPlumRainDay() {
        const grainInEar = SolarTerm2.fromIndex(this.getYear(), 11);
      ...
      getNineDay() {
        ...
        let start = SolarTerm2.fromIndex(year + 1, 0).getSolarDay();
        if (this.isBefore(start)) {
          start = SolarTerm2.fromIndex(year, 0).getSolarDay();
        }
      ...
      getLunarDay() {
        ...
        return LunarDay2.fromYmd(m.getYear(), m.getMonthWithLeap(), days + 1);
      }
      getRabByungDay() {
      ...
      getLegalHoliday() {
        return LegalHoliday2.fromYmd(this.getYear(), this.getMonth(), this.getDay());
      }
      getFestival() {
        return SolarFestival2.fromYmd(this.getYear(), this.getMonth(), this.getDay());
      }
      getPhaseDay() {
    ...
    var SolarTime = class _SolarTime extends SecondUnit {
      ...
      static validate(year, month, day, hour, minute, second) {
        SecondUnit.validate(year, month, day, hour, minute, second);
        SolarDay2.validate(year, month, day);
      }
      static fromYmdHms(year, month, day, hour, minute, second) {
        return new _SolarTime(year, month, day, hour, minute, second);
      }
      getSolarDay() {
        return SolarDay2.fromYmd(this.getYear(), this.getMonth(), this.getDay());
      }
      getName() {
    ...
    var LegalHoliday2 = class _LegalHoliday extends AbstractTyme {
      ...
      constructor(year, month, day, data) {
        super();
        this.day = SolarDay2.fromYmd(year, month, day);
    ...
    var SolarFestival2 = class _SolarFestival extends AbstractTyme {
      ...
      static fromIndex(year, index) {
        ...
        if (matcher) {
          ...
          if (type === 0) {
            ...
            if (year >= startYear) {
              return new _SolarFestival(0, SolarDay2.fromYmd(year, parseInt(data.substring(4, 6), 10), parseInt(data.substring(6, 8), 10)), startYear, data);
            }
          }
        }
        return null;
      ...
      static fromYmd(year, month, day) {
        ...
        if (matcher) {
          ...
          const startYear = parseInt(data.substring(8), 10);
          if (year >= startYear) {
            return new _SolarFestival(0, SolarDay2.fromYmd(year, month, day), startYear, data);
          }
        }
        return null;
      }
    ...
    var LunarFestival2 = class _LunarFestival extends AbstractTyme {
      ...
      static fromIndex(year, index) {
        ...
        if (matcher) {
          ...
          switch (type) {
            case 0:
              return new _LunarFestival(0, LunarDay2.fromYmd(year, parseInt(data.substring(4, 6), 10), parseInt(data.substring(6), 10)), null, data);
            case 1:
              const solarTerm = SolarTerm2.fromIndex(year, parseInt(data.substring(4), 10));
              return new _LunarFestival(1, solarTerm.getSolarDay().getLunarDay(), solarTerm, data);
            case 2:
              return new _LunarFestival(2, LunarDay2.fromYmd(year + 1, 1, 1).next(-1), null, data);
          }
        }
        return null;
      }
      static fromYmd(year, month, day) {
        ...
        if (matcher) {
          return new _LunarFestival(0, LunarDay2.fromYmd(year, month, day), null, matcher[0]);
        }
        const lunarDay = LunarDay2.fromYmd(year, month, day);
        const solarDay = lunarDay.getSolarDay();
        const reg = new RegExp(`@\\d{2}1\\d{2}`, "g");
        while (matcher = reg.exec(_LunarFestival.DATA)) {
          const data = matcher[0];
          const term = SolarTerm2.fromIndex(year, parseInt(data.substring(4), 10));
    ...
    var KitchenGodSteed = class _KitchenGodSteed extends AbstractCulture {
      ...
      constructor(lunarYear) {
        super();
        this.firstDaySixtyCycle = LunarDay2.fromYmd(lunarYear, 1, 1).getSixtyCycle();
      }
    ...
    var RabByungDay = class _RabByungDay extends AbstractTyme {
      ...
      static fromSolarDay(solarDay) {
        let days = solarDay.subtract(SolarDay2.fromYmd(1951, 1, 8));
      ...
      getSolarDay() {
        ...
        return SolarDay2.fromYmd(1951, 1, 7).next(n + t);
      }
    };
    exports2.AbstractChildLimitProvider = AbstractChildLimitProvider;
    exports2.AbstractCulture = AbstractCulture;
    exports2.AbstractCultureDay = AbstractCultureDay;
    exports2.AbstractTyme = AbstractTyme;
    exports2.Animal = Animal;
    exports2.Beast = Beast;
    exports2.ChildLimit = ChildLimit;
    exports2.ChildLimitInfo = ChildLimitInfo;
    exports2.China95ChildLimitProvider = China95ChildLimitProvider;
    exports2.Constellation = Constellation;
    exports2.DayUnit = DayUnit;
    exports2.DecadeFortune = DecadeFortune;
    exports2.DefaultChildLimitProvider = DefaultChildLimitProvider;
    exports2.DefaultEightCharProvider = DefaultEightCharProvider;
    exports2.Dipper = Dipper;
    exports2.Direction = Direction;
    exports2.Dog = Dog;
    exports2.DogDay = DogDay;
    exports2.Duty = Duty;
    exports2.EarthBranch = EarthBranch;
    exports2.Ecliptic = Ecliptic;
    exports2.EightChar = EightChar;
    exports2.Element = Element;
    exports2.FestivalType = FestivalType;
    exports2.FetusDay = FetusDay2;
    exports2.FetusEarthBranch = FetusEarthBranch;
    exports2.FetusHeavenStem = FetusHeavenStem;
    exports2.FetusMonth = FetusMonth;
    exports2.Fortune = Fortune;
    exports2.Gender = Gender;
    exports2.God = God;
    exports2.HeavenStem = HeavenStem;
    exports2.HideHeavenStem = HideHeavenStem;
    exports2.HideHeavenStemDay = HideHeavenStemDay;
    exports2.HideHeavenStemType = HideHeavenStemType;
    exports2.JulianDay = JulianDay;
    exports2.KitchenGodSteed = KitchenGodSteed;
    exports2.Land = Land;
    exports2.LegalHoliday = LegalHoliday2;
    exports2.LoopTyme = LoopTyme;
    exports2.Luck = Luck;
    exports2.LunarDay = LunarDay2;
    exports2.LunarFestival = LunarFestival2;
    exports2.LunarHour = LunarHour;
    exports2.LunarMonth = LunarMonth;
    exports2.LunarSeason = LunarSeason;
    exports2.LunarSect1ChildLimitProvider = LunarSect1ChildLimitProvider;
    exports2.LunarSect2ChildLimitProvider = LunarSect2ChildLimitProvider;
    exports2.LunarSect2EightCharProvider = LunarSect2EightCharProvider;
    exports2.LunarWeek = LunarWeek;
    exports2.LunarYear = LunarYear;
    exports2.MinorRen = MinorRen;
    exports2.MonthUnit = MonthUnit;
    exports2.Nine = Nine;
    exports2.NineDay = NineDay;
    exports2.NineStar = NineStar;
    exports2.PengZu = PengZu2;
    exports2.PengZuEarthBranch = PengZuEarthBranch;
    exports2.PengZuHeavenStem = PengZuHeavenStem;
    exports2.Phase = Phase;
    exports2.PhaseDay = PhaseDay;
    exports2.Phenology = Phenology;
    exports2.PhenologyDay = PhenologyDay;
    exports2.PlumRain = PlumRain;
    exports2.PlumRainDay = PlumRainDay;
    exports2.RabByungDay = RabByungDay;
    exports2.RabByungElement = RabByungElement;
    exports2.RabByungMonth = RabByungMonth;
    exports2.RabByungYear = RabByungYear;
    exports2.SecondUnit = SecondUnit;
    exports2.SevenStar = SevenStar;
    exports2.ShouXingUtil = ShouXingUtil;
    exports2.Side = Side;
    exports2.SixStar = SixStar;
    exports2.Sixty = Sixty;
    exports2.SixtyCycle = SixtyCycle;
    exports2.SixtyCycleDay = SixtyCycleDay;
    exports2.SixtyCycleHour = SixtyCycleHour;
    exports2.SixtyCycleMonth = SixtyCycleMonth;
    exports2.SixtyCycleYear = SixtyCycleYear;
    exports2.SolarDay = SolarDay2;
    exports2.SolarFestival = SolarFestival2;
    exports2.SolarHalfYear = SolarHalfYear;
    exports2.SolarMonth = SolarMonth;
    exports2.SolarSeason = SolarSeason;
    exports2.SolarTerm = SolarTerm2;
    exports2.SolarTermDay = SolarTermDay;
    exports2.SolarTime = SolarTime;
    exports2.SolarWeek = SolarWeek;
    exports2.SolarYear = SolarYear;
    exports2.Sound = Sound;
    exports2.Taboo = Taboo;
    exports2.Ten = Ten;
    exports2.TenStar = TenStar;
    exports2.Terrain = Terrain;
    exports2.ThreePhenology = ThreePhenology;
    exports2.ThreePillars = ThreePillars;
    exports2.TwelveStar = TwelveStar;
    exports2.Twenty = Twenty;
    exports2.TwentyEightStar = TwentyEightStar;
    exports2.Week = Week;
    exports2.WeekUnit = WeekUnit;
    exports2.YearUnit = YearUnit;
    exports2.YinYang = YinYang;
    exports2.Zodiac = Zodiac;
    exports2.Zone = Zone;
  }
});

// public/preload/services.js
var { SolarDay, LunarDay, SolarTerm, LegalHoliday, SolarFestival, LunarFestival, PengZu, FetusDay } = require_lib();
...
var shichenTimeRanges = ["23:00-01:00", "01:00-03:00", "03:00-05:00", "05:00-07:00", "07:00-09:00", "09:00-11:00", "11:00-13:00", "13:00-15:00", "15:00-17:00", "17:00-19:00", "19:00-21:00", "21:00-23:00"];
var twelveGods = ["\u9752\u9F99", "\u660E\u5802", "\u5929\u5211", "\u6731\u96C0", "\u91D1\u532E", "\u5929\u5FB7", "\u767D\u864E", "\u7389\u5802", "\u5929\u7262", "\u7384\u6B66", "\u53F8\u547D", "\u52FE\u9648"];
var yellowRoadGods = /* @__PURE__ */ new Set(["\u9752\u9F99", "\u660E\u5802", "\u91D1\u532E", "\u5929\u5FB7", "\u7389\u5802", "\u53F8\u547D"]);
